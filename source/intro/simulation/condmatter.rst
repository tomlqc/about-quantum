...
Because it is a very specialized and technical topic, we refer directly to
three review papers about the topic, and provide a basic list of selected applications.
...
- In a typical condensed-matter system, electrons can be modelled as moving on a lattice
  ...
  Such a general setting can be simulated with ultracold atoms usingthe concept of an "optical lattice".
